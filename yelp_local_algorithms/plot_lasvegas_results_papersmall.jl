using Plots
using MAT
using SparseArrays, Statistics, Measures
...
#yl = [36,36.3]
xl = [-115.35,-115.01] # crops out outskirts of town
yl = [36,36.31]
...
plot!(p1, margin=-20mm, size=(400,400))

savefig("Plots/LH_heatmap_small.pdf")
## Now for PR
rev = false
...
plot!(p2, margin=-20mm, size=(400,400))
savefig("Plots/CliqueACL_heatmap_small.pdf")
...
plot(p3, margin=-20mm, size=(400,400)))
savefig("Plots/StarACL_heatmap_small.pdf")
...
plot!(p4, margin=-20mm, size=(400,400)))
savefig("Plots/Flow_heatmap_small.pdf")
...
plot!(p5, margin=-20mm, size=(400,400)))
savefig("Plots/Flow_refinement_heatmap_small.pdf")
...
pr = med[1]; re = med[2]; f1 = med[3]
p6 = scatter(xy[:,1],xy[:,2], markerstrokecolor = bcolor, markercolor = bcolor,markersize = ms)
p6 = scatter!(xy[p,1],xy[p,2], grid = false, axis = false,legend = false,
...
plot!(p6, margin=-20mm, size=(400,400))
savefig("Plots/Qpr_heatmap_small.pdf")
